...
# ── Config ────────────────────────────────────────────────────────────────────
CSV_PATH = "dataset_generation/medqa_hallucinated.csv"          # change if your file lives elsewhere
OUTPUT_PATH = "dataset_generation/hallucination_difficulty_chart.png"
...
def main():
    ...
    df_actual = load_data("dataset_generation/medhallu_dataset_artificial.csv")[:500]
